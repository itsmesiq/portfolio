...
export default function Header() {
    ...
    return (
        <header className={`w-full items-center flex justify-between py-6 px-5 xl:px-16 bg-background font-heading text-base font-normal fixed top-0 z-50 ${isMenuOpen ? 'bg-background' : scrolled ? 'bg-background/90 backdrop-blur-md transition-colors duration-300' : 'bg-transparent transition-colors duration-300'} hover:bg-background`}>
            <DesktopNav />
